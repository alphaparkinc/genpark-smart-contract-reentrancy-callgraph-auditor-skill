# genpark-smart-contract-reentrancy-callgraph-auditor-skill
...
**genpark-smart-contract-reentrancy-callgraph-auditor-skill** is a deterministic, zero-dependency Python skill engineered for autonomous smart contract auditing, callgraph verification, signature phishing defense, and DeFi vulnerability triage.

> **Executive Capability**: Solidity callgraph & control-flow reentrancy vulnerability auditor (Slither / Immunefi)
...
result = client.audit_contract_callgraph()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-smart-contract-reentrancy-callgraph-auditor-skill": {
      "command": "python",
      "args": ["/path/to/genpark-smart-contract-reentrancy-callgraph-auditor-skill/mcp_server.py"]
    }
  }
}
```
